/**
 * rsa.js  —  Shared RSA utility for the bridge
 *
 * This is an exact copy of the Middleware's /src/utils/rsa.js.
 * Both the ESP32 (hardware) and the middleware use the same toy RSA
 * key pair for this demonstration project.
 *
 * Keys: p=61, q=53, n=3233, phi=3120, e=17, d=2753
 *
 * encryptToHash(plaintext)  → base64 string  (encrypt char-by-char)
 * decryptFromHash(base64)   → original plaintext string
 */
